...
function startHacking() {
    ...
    let steps = ["Conectando ao alvo...", "Ignorando firewall...", "Acessando dados...", "Buscando informações..."];
    let index = 0;
    ...
    const interval = setInterval(() => {
        if (index < steps.length) {
            ...
            progressText.textContent = "HACKING COMPLETO!";
...
function fetchUserIP() {
    ...
    fetch('https://api.ipify.org?format=json')
        ...
        .catch(error => console.error('Erro ao buscar IP do usuário:', error));
}
    ...
    fetch(apiUrl)
        ...
        .then(data => {
            ...
            const details = {
                ...
                SecureConnection: window.location.protocol === 'https:' ? 'sim' : 'nwo',
                ...
                Weather: "Buscando dados meteorológicos..",
                Hacked: "sim",
                HackedBy: "L E O M O D S H A C K E R B R",
                CurrentStatus: "Não disponível"
            };
